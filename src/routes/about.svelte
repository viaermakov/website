  ...
  <div class="main">
    ...
    <section class="base-info">
      <p>
        ...
        и на Github пара небольших проектов) и учить разные новые вещи
      ...
      <h4>Образование</h4>
      <p>
        Программистом захотел стать в 10 классе и даже начинал учить C++. После
        школы поступил в НИТУ МИСиС на информатику. Закончил с отличием. Также
    ...
    <div class="description">
      <div>
        ...
        <p>
          ...
          количество опыта. Работаю в продукте Авиа. Все пишем в основном на
          React и Redux.
        </p>
        <h5>Чем занимаюсь:</h5>
        <ul class="results">
          ...
          <li>
            ...
            React-Router(v1 → v4). Иногда переписываю приложения с Redux,
            Redux-Form на Effector и React-hook-form и рассказываю, что
            улучшилось с точки зрения бизнеса и с точки зрения разработки.
          </li>
          <li>
  ...
  <div class="job">
    ...
    <div class="description">
      <div>
        ...
        <p>
          На 3 курсе универа стал искать работу. Наткнулся на вакансию в
          <a
            href="https://www.alfastrah.ru/"
            alt="link to AlfaStrahovanie website">
            АльфаСтрахование-ОМС
          </a>
          , после тестового задания и собеседования получил оффер. Устроился
          работу с первого раза. В компании с нуля разрабатывал внутреннюю
          систему для медицинских экспертов, которая отличалась огромным
          количеством различных сложных форм и словарей.
        </p>
        <h5>Чем занимался:</h5>
        <ul>
          ...
          <li>
            Под конец немного помогал джуну, который недавно пришел к нам в
            компанию.
          </li>
        </ul>
      </div>
