  ...
  <div class="job">
    ...
    <div class="description">
      <div>
        ...
        <p>
          Понравилось, что делает компания. Работаю в команде Авиа, которая отвечает за весь флоу покупки и возвратов авиабилетов.
          Приложение включается себя страницы поиска и фильтров, офрмления и оплаты билетов. Проект большой с различной сложной логикой.
          Пишу в основном на React и Redux.
        </p>
        <h5>Чем занимаюсь:</h5>
        <ul class="results">
          <li>
          ...
          <li>
            Сражаюсь с легаси. Поднимаю старые библиотеки, в том числе значимо архитектурные, например
            React-Router(v1 → v4), Webpack. 
          </li>
          <li>
          ...
          <li>
            Пишу и чиню юнит тесты, E2E-тесты на Jest и
            Puppeteer.
          </li>
          <li>
            Пишу компоненты для Реакт библиотеки не только для Авиа, но и для всех продуктов OneTwoTrip.
          </li>
      ...
      <ul class="results">
        <li>
            Переписал одно из приложений с Redux,
            Redux-Form на Effector и React-hook-form и рассказывал, что
        ...
        <li>
          Внедрил различные практики в CI. Например, затащил в проекты Typescript и Eslint, добавил в пайплайны
          для Jenkins сборок.
        </li>
      </ul>
    </div>
    ...
    <div class="description">
      <div>
        ...
        <p>
          ...
          </a>. В компании с нуля разрабатывал внутреннюю
          систему для медицинских экспертов, которая отличалась огромным
          количеством различных сложных форм и словарей.
        </p>
        <h5>Чем занимался:</h5>
        <ul>
          <li>Писал различные фичи на React, Redux и связанной с ним архитектуре.</li>
          <li>
      ...
      <ul class="results">
        <li>
          Почти полностью один написал библиотеку Реакт компонентов для 2ух команд;
        </li>
        <li>
